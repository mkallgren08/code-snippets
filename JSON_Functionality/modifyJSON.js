...
module.exports = {
  ...
  makeJson: (args) => {
    ...
    let strArr=this.strToArr(args.str, args.delim)
  ...
  run: () => {
    console.log("Reading args in run method:")
    console.log (opts)
    console.log("checking on 'this'")
    console.log(this)
    // this.jobSelect(this.opts);
  },
  opts: opts
}

testOutput => {return "Hello world!"}
...
var runThis = function(args) {
  console.log("Reading args in runThis function:")
  console.log (args)
  pick(args);
};
